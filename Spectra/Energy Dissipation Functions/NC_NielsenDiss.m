function[fw,u_br,fe,TED_fe] = NC_NielsenDiss(See,ff,h,kw,a1,a2,a3,Method)
%
%NC_NIELSENDISS determines the theoretical energy dissipations at each 
% time and at each frequency by using the energy dissipation factors from 
% Nielsen's [1992] method from "Spectral wave dissipation over a barrier 
% reef" by Lowe.
%
%
% Details:
...
%          paper)
%       - a1, a2, & a3: Nielsen's [1992] coefficients which are typically
...
% 
% Outputs:
%       - fw: the Nielsen friction factors
%       - u_br: the representative bottom orbital velocities
%       - fe: Nielsen energy dissipation factors
%       - TED_fe: the energy dissipation(theoretical) using the Nielsen
